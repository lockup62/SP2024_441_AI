...
def get_landscape(pixel_map):
    return elevation_to_rgba(get_elevation(pixel_map))


def get_combat_bg(pixel_map):
    return elevation_to_rgba(get_elevation(pixel_map, 10), "RdPu")
